...
-----------------------------------------------------------------------------------------------
-- Still trying to figure out if this is a contant time, and fine tuning the #
-- Yes this is a stupid way to do it - some day I will work out a real timer


            player:SetResources(.0550009052 + player:GetResources())
------------------------------------------------------------------------------------------            
        end
